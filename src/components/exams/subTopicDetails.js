  ...
  return (
      <Box bg="#fff" p="6" rounded="2xl">
        ...
        <Box pt="4">
          ...
          <br />
          <Text>
            Both essays are graded holistically, meaning, "based on an overall impression." This means that you'll be
            judged not only on your reasoning, but also on how you write (the basics: putting sentences together, using
            the correct words and punctuating properly).
          </Text>
        </Box>
        <Box>
