    ...
    <Box display={{ md: "none", lg: "block", sm: "none" }}>
      <UnorderedList styleType="none" textAlign="start" color="#455564">
        <CustomLinkItem href="/useraccount">
          <ListItem key="1" className="flex justify-between items-center" fontSize="14px" fontWeight="semibold">
        ...
        <Text color="#8D96A5" fontSize="12px" lineHeight="2" fontWeight="700">
          MY ACTIVITIES
        </Text>
        <ListItem className="flex justify-between items-center" py="3" fontSize="14px" fontWeight="semibold">
        ...
        <Text color="#8D96A5" fontSize="12px" lineHeight="2" fontWeight="700" textTransform="uppercase">
          My Rewards & Payments
        </Text>
        <ListItem className="flex justify-between items-center" py="3" fontSize="14px" fontWeight="semibold">
