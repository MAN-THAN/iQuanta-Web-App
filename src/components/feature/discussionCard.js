import { Box, Card, CardBody, CardHeader, Divider, Flex, HStack, Image, Input, InputGroup, InputLeftAddon, InputLeftElement, InputRightElement, Stack, Text } from '@chakra-ui/react'
import { Dot, ImageIcon, ImagePlus } from 'lucide-react'
    ...
    return (
        <Box>
            <Card maxW='xs' bg='#fff' rounded='xl'>
                <CardHeader>
                    <Text textAlign='center' color='black.400' fontSize="12px">Discussion(3)</Text>
                    <InputGroup mt='4' >
                        <InputLeftElement>
                            <Box boxSize='30px'>
                                <Image
                        ...
                        items={[
                            {
                                children: <Stack>
                                    ...
                                    <Text paddingLeft="3rem" textAlign='justify' fontSize='14px' >
                            ...
                            {
                                children: <Stack paddingLeft='3rem' pt='3'>
                                    <Box
                                        sx={{
                                            display: 'flex',
                                            alignItems: 'center',
