                            ...
                            <Stack>
                                <HStack align="center" padding={['3', null, '4']}>
                                    ...
                                    >
                                        ...
                                        <Box ml="2">
                                            <p style={{ fontSize: '16px', color: '#171717', fontWeight: '600' }}>Hardik Beniwal</p>
                                ...
                                <Stack direction='row' align='center' justify='space-between' fontSize='14px' fontWeight='500' py='1' px='4'>
                                    <Box variant='link' display='flex' alignItems='flex-end'>
                                        <Box><ThumbsUp /></Box><span>Like</span>
                                    </Box>
                                    <Box variant='link' display='flex' alignItems='flex-end'>
                                        <Box><MessageCircle /></Box><span>Comments</span>
                                    </Box>
                                    <Box variant='link' display='flex' alignItems='flex-end'>
                                        <Box><Share2 /> </Box><span>Share</span>
                                    </Box>
                                </Stack >
                                ...
                                <Box px='4' py='0'>
                                    <Box sx={{
                                        ...
                                        <Box ml='2'>
                                            <p style={{ fontSize: "12px", color: "#171717", fontWeight: "600", lineHeight: '13px' }}>Hardik Beniwal</p>
