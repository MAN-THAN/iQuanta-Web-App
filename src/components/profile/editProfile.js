"use client"
import { Badge, Box, Card, CardBody, Flex, HStack, Image, Input, InputGroup, InputLeftAddon, Stack, Text, Textarea, useDisclosure } from '@chakra-ui/react'
import {
    FormControl,
    FormLabel,
    FormErrorMessage,
...
const EditProfile = () => {
    ...
    return (
        <Box >
            <Card >
                <CardBody alignItems='center' justifyContent='center' p='6'>
                    <Box position='relative'>
                        ...
                        <Box onClick={onOpen} position='absolute' left='50%' transform='translateX(-50%)' top='40%' bg='#fff' rounded='full'>
                    ...
                    <Box mt='16' >
                        ...
                        <Flex align="center" justify='center' fontSize='md' color='text.700'>
                            <span>Male,23 years</span><span><BsDot /></span>
                            <span>Mumbai, Maharashtra </span>
                        </Flex>
                    </Box>
                    <Flex align='center' justify='center' gap={3} pt='4' >
                        <Badge px='4' py='2' rounded='2xl' color='text.900' colorScheme='green'>CAT</Badge>
                        <Badge px='4' py='2' rounded='2xl' color='text.900' colorScheme='red'>GMAT</Badge>
                        <Badge px='4' py='2' rounded='2xl' color='text.900' colorScheme='purple'>GRE</Badge>
                    </Flex>
                    <Box fontSize='md' pt='5'>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ex esse laborum error, possimus culpa tenetur aliquam neque corrupti excepturi ratione expedita illum amet saepe tempore voluptas. Corporis animi veniam accusamus!</p>
                    </Box>
                </CardBody>
            </Card>
            ...
            <Card mt='1'>
                <CardBody alignItems='center' justifyContent='center' p='6'>
                    <Text textAlign='start' color='heading.700' fontWeight='semibold' fontSize='lg'>My Details</Text>
                    <FormControl display='flex' gap='1' flexWrap='wrap' mt='4'>
                        ...
                        <Box width='100%'>
                            ...
                            <Textarea placeholder='Here is a sample placeholder' readOnly value='Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ex esse laborum error, possimus culpa tenetur aliquam neque corrupti excepturi ratione expedita illum amet saepe tempore voluptas. Corporis animi veniam accusamus!' />
                        </Box>
                    </FormControl>
                    <Text resize="none" overflow='scroll' css={{
                        "&::-webkit-scrollbar": {
                            width: "0.5em",
                        },
                    ...
                    }} textAlign='start' color='heading.700' fontWeight='semibold' fontSize='lg' mt='4'>My Personal Information</Text>
                    <FormControl display='flex' gap='1' flexWrap='wrap' mt='4'>
                        <Box width='48%'>
