      ...
      <div style={{ backgroundColor: "#fff" }}>
        ...
        <Box p="6">
          <Stack>
            ...
            <Text pt="4" fontSize="14px" fontWeight="400" color="#16222C">
              Be prepared and get exam-ready to face CAT exam with live Interactive sessions taken by our faculty from
                    ...
                    <HStack align="self-start">
                      ...
                      <Stack pl="3">
                        ...
                        <Text fontSize="14px" fontWeight="400" color="#455564">
                          Expert Support throughout CAT preparation and further exams. 100+ Live Sessions and 500+
                          Videos.
                        </Text>
                      </Stack>
                    </HStack>
        ...
        <Box p="6">
          <Stack>
            ...
            <Box color="#455564" fontWeight="400" lineHeight="40px" pt="4">
              ...
              <p>
                <span style={{ fontWeight: "600" }}>Mocks (Bonus):</span> Video Solutions For All LRDI Sets in Full
                Mocks & Assignments.
              </p>
        ...
        <Box p="6">
          <Stack>
            ...
            <Box color="#455564" fontWeight="400" lineHeight="40px" pt="4">
              <p>
                A combination of well explained shortcuts, concepts, their application in form of videos, pics, texts
                and unlimited practice.
              </p>
