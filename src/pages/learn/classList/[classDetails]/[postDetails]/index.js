    ...
    <Box bg="#fff" mt="4" rounded="xl">
      ...
      <Stack padding={["3", null, "4"]}>
        <Text fontSize="14px" lineHeight="24px">
          ...
          concentrate on some of the finer details. Both essays are graded
          holistically. This means that you'll be judged not only on your
          reasoning, but also on how you write...
          <br />
      ...
      <Stack padding={["3", null, "4"]}>
        ...
        <Stack>
          ...
          <Text paddingLeft="4rem" textAlign="justify" fontSize="14px">
            Yes, you can! But you need to be in 99.5%iler. I was also in such a
            situation earlier this year. If I had known this, than I wouldn’t
            have grinded this if it weren’t for Banking exam. Moreover, If
            anyone is interested, feel free to go through my courses. You’ll
            like it :)
          </Text>
...
PostDetails.getLayout = (page) => <RootLayout   >{page}</RootLayout>;
