      ...
      <Box bg="#fff" p="6">
        <VStack color="#16222C" align="start">
          ...
          <Text fontSize="16px" fontWeight="400" lineHeight="21.8px">
            Get admission into a graduate management program, such as MBA and
            Masters in Finance related courses in top business schools across
            the world.
          </Text>
          ...
          <Text fontSize="16px" fontWeight="400" lineHeight="21.8px">
            The candidate must have completed 18 years of age; however, there is
            no upper age limit of the candidate applying to take the test. If
            you are a student falling between the age group of 13 to 17 years,
            you should have permission in writing from your parents or from your
            legal guardian.
          </Text>
          ...
          <Text fontSize="16px" fontWeight="400" lineHeight="21.8px">
            People of all nationalities can take the GMAT. All the rules and
            guidelines prescribed by the GMAC are equally applicable to
            everyone, regardless of which country they come from. An interesting
            thing to note here is that there might be some specific rules about
            the identity{" "}
          </Text>
        </VStack>
      </Box>
