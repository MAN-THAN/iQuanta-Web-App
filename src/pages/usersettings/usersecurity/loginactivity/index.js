            ...
            <Card>
                <CardHeader>
                    <HStack>
                        ...
                        <Text fontSize='18px' fontWeight='600'>My Login Activity</Text>
                    </HStack>
                </CardHeader>
                <CardBody>
                    <Stack>
                        ...
                        <HStack align="center" justify='space-between'>
                            <Box sx={{
                                ...
                                <Box pl='4'>
                                    ...
                                    <p style={{ fontSize: "14px", color: "#24B670", display: 'flex' }}>Active Now <Dot /><span style={{ color: "#455564" }}>iPhone6s</span></p>
                                </Box>
                            </Box></HStack>
                    </Stack>
                </CardBody>
